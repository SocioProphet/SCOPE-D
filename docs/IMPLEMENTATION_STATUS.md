...
- deterministic dashboard export through `dashboard-summary.json`, generated only from verified run summaries and marked non-production-only;
...
- dashboard export is a deterministic JSON handoff, not yet a live SocioSphere UI integration;
...
- live SocioSphere dashboard integration;
